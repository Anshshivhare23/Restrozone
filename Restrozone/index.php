                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
								echo '<li class="nav-item"><a href="admin/index.php" class="nav-link active">Admin Dashboard</a> </li>';
								echo '<li class="nav-item"><a href="restaurant/index.php" class="nav-link active">Restaurant Dashboard</a> </li>';
							...
							{	
                                    ...
                                    echo   '<li class="nav-item user-dropdown">
                              <a class="nav-link active user-icon" onclick="toggleDropdown(this)">User</a>
